#' @title Export Excel Sheets
#'
#' @description Export data frames to Excel
#'
#' @details This function will save data frames to Excel by worksheet.
#'
#' Each data frame is saved to a worksheet.
#'
#' A NOTES worksheet can be included as the first worksheet in the workbook.
#'
...
#' Default = Sort_Group
#' @param include.notes Boolean to include a NOTES worksheet.  Default = TRUE
